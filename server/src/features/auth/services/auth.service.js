...
import {ConflictError, NotFoundError, UnauthorizedError, ValidationError} from "../../../core/errors/api.error.js";
import BaseService from "../../../core/base/base.service.js";
import {userBaseSchema as existingUser, userBaseSchema as newUser} from "../../../core/validations/schemas/user.schema.js";
...
export default class AuthService extends BaseService {
    ...
    resendVerificationEmail = async (userData) => {
        console.log("Resend email request received:", userData.email);
        const existingUser = await this.repository.findByEmail(userData.email);
        ...
        console.log("OTP updated in database, sending email...");
